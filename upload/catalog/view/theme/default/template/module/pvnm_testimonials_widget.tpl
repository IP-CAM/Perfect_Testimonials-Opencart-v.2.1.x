	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<a href="<?php echo $home; ?>" class="lead"><?php echo $text_rating; ?></a>
				<hr>
	...
	<div class="col-md-12" id="testimonial<?php echo $testimonial['testimonial_id']; ?>">
		<div class="row">
			...
			<div class="col-xs-6 text-right testimonial-height">
				<span class="testimonial-rating-stars" style="margin: 0;"><span style="width: <?php echo $testimonial['rating'] * 19; ?>px;"></span></span>
				<a href="<?php echo $home; ?>#testimonial<?php echo $testimonial['testimonial_id']; ?>" style="float: right;margin-left: 5px;"><i class="fa fa-link"></i></a>
			</div>
		</div>
		<br>
		<div class="row">
